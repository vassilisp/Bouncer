...
CC = gcc
files = bouncer.c utils.c process_pkt.c ping_list.c ping.c tcp_list.c tcp.c ftp_list.c ftp_list.h
objects = bouncer.o utils.o process_pkt.o ping_list.o ping.o tcp_list.o tcp.o ftp_list.o
LIBS = -lpcap
BOUNCER = bouncer
...
ftp_list.o: ftp_list.c ftp_list.h globals.h
	$(CC) -c ftp_list.c
